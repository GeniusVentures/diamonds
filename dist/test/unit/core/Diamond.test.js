...
describe('Diamond', () => {
    ...
    describe('function selector registry', () => {
        it('should register function selectors', () => {
            ...
            (0, chai_1.expect)(entry === null || entry === void 0 ? void 0 : entry.facetName).to.equal('TestFacet');
            (0, chai_1.expect)(entry === null || entry === void 0 ? void 0 : entry.priority).to.equal(100);
            (0, chai_1.expect)(entry === null || entry === void 0 ? void 0 : entry.action).to.equal(types_1.RegistryFacetCutAction.Add);
        });
        it('should update function selectors', () => {
            ...
            const entry = diamond.functionSelectorRegistry.get(selector);
            (0, chai_1.expect)(entry === null || entry === void 0 ? void 0 : entry.facetName).to.equal('UpdatedFacet');
            (0, chai_1.expect)(entry === null || entry === void 0 ? void 0 : entry.priority).to.equal(200);
            (0, chai_1.expect)(entry === null || entry === void 0 ? void 0 : entry.action).to.equal(types_1.RegistryFacetCutAction.Replace);
        });
    });
    describe('deployed diamond data', () => {
        it('should get and update deployed diamond data', () => {
            const data = diamond.getDeployedDiamondData();
            (0, chai_1.expect)(data.DiamondAddress).to.be.undefined;
