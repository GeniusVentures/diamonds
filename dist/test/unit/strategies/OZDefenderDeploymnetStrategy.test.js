...
describe('OZDefenderDeploymentStrategy', () => {
    ...
    beforeEach(async () => {
        ...
        SAFE_ADDRESS, 'Safe', true, // verbose
        mockDefenderClient // customClient
        );
    });
    after(async () => {
    ...
    describe('deployDiamondTasks', () => {
        it('should submit DiamondCutFacet and Diamond deployment to Defender', async () => {
            ...
            (0, chai_1.expect)(firstCallArgs.contractName).to.equal('MockDiamondCutFacet');
            ...
            (0, chai_1.expect)(secondCallArgs.contractName).to.equal('MockDiamond'); // Mapped from TestDiamond
    ...
    describe('pollUntilComplete', () => {
        ...
        it('should handle failed deployments', async () => {
            ...
            try {
                ...
                chai_1.expect.fail('Expected method to throw an error on failed deployment');
            }
            catch (error) {
                // This is expected - the method should throw when deployment fails
                (0, chai_1.expect)(error).to.be.an('error');
                (0, chai_1.expect)(error.message).to.include('Deployment failed');
            }
