...
export declare class BaseDeploymentStrategy implements DeploymentStrategy {
    ...
    protected _preDeployDiamond(diamond: Diamond): Promise<void>;
    ...
    protected _preDeployFacets(diamond: Diamond): Promise<void>;
    deployFacets(diamond: Diamond): Promise<void>;
    protected postDeployFacets(diamond: Diamond): Promise<void>;
