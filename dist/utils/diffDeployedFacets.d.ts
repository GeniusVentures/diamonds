...
export declare function diffDeployedFacets(deployedDiamondData: DeployedDiamondData, signerOrProvider: Signer | providers.Provider, verboseGetDeployedFacets?: boolean): Promise<boolean>;
