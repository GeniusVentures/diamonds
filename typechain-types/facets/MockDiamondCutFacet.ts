...
export interface MockDiamondCutFacetInterface extends Interface {
...
export interface MockDiamondCutFacet extends BaseContract {
  connect(runner?: ContractRunner | null): MockDiamondCutFacet;
  waitForDeployment(): Promise<this>;

  interface: MockDiamondCutFacetInterface;
