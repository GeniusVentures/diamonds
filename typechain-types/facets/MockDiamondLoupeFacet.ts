...
export interface MockDiamondLoupeFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "facetAddress"
      | "facetAddresses"
...
export interface MockDiamondLoupeFacet extends BaseContract {
  connect(runner?: ContractRunner | null): MockDiamondLoupeFacet;
  waitForDeployment(): Promise<this>;

  interface: MockDiamondLoupeFacetInterface;
