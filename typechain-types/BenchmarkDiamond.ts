...
export interface BenchmarkDiamondInterface extends Interface {
...
export interface BenchmarkDiamond extends BaseContract {
  connect(runner?: ContractRunner | null): BenchmarkDiamond;
  waitForDeployment(): Promise<this>;

  interface: BenchmarkDiamondInterface;
